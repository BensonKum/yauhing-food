  ...
  document.getElementById('logSidebar').innerHTML =
    ...
    '<div class="log-card" style="background:#fff;border:1px solid #e0e0e0">' +
      ...
      '<div style="display:flex;flex-direction:column;gap:.15rem">' +
        ...
        '<button onclick="onDateRangeChange()" style="margin-top:.2rem;padding:.35rem;background:#2196f3;color:#fff;border:none;border-radius:4px;font-size:.8rem;cursor:pointer">確定</button>' +
      '</div>' +
    '</div>';
