...
# Find and replace 十年陳皮鴨湯麵 card (multi-pack style)
old = '''<div class="p-card has-image" data-cat="蝦籽麵" data-stock="in"><div class="p-img"><span class="s-badge in">有庫存</span><div class="pk-sw"><button class="pk-btn active" data-pk="1">單包</button><button class="pk-btn" data-pk="2">6個裝</button></div><img src="images/十年陳皮鴨湯麵.jpg" alt="十年陳皮鴨湯麵" loading="lazy"><img src="images/十年陳皮鴨湯麵6個裝.jpg" alt="十年陳皮鴨湯麵" loading="lazy" style="display:none;"></div><div class="p-info"><div class="p-cat">蝦籽麵</div><h3 class="p-name">十年陳皮鴨湯麵</h3><div class="p-note">單包 / 6個裝 HKD 80</div><div class="p-price multi">HKD 15 (單包) / HKD 80 (6個裝)</div></div></div>'''
...
if old in html:
    html = html.replace(old, card_602a + '\n' + card_602)
    print('Replaced 十年陳皮鴨湯麵 with 2 cards ✅')
else:
    print('ERROR: exact string not found!')
    # Show what's there
    idx = html.find('十年陳皮鴨湯麵')
    print(html[idx-50:idx+len(old)+50])
